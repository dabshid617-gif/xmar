...
const OAUTH_CLIENT_ID =
  process.env['GOOGLE_OAUTH_CLIENT_ID'] || '<configure-client-id>';
...
const OAUTH_CLIENT_SECRET =
  process.env['GOOGLE_OAUTH_CLIENT_SECRET'] || '<configure-client-secret>';

function ensureClientCredentials() {
  if (!OAUTH_CLIENT_ID || !OAUTH_CLIENT_SECRET) {
    throw new FatalAuthenticationError(
      'Missing Google OAuth credentials. Please set GOOGLE_OAUTH_CLIENT_ID and GOOGLE_OAUTH_CLIENT_SECRET.',
    );
  }
}
